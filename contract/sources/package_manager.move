module deployer::package_manager {
    use aptos_framework::account::{Self, SignerCapability, create_resource_account};
    use aptos_framework::resource_account;
    use aptos_std::smart_table::{Self, SmartTable};
    use std::string::String;

    friend deployer::coin_wrapper;
    friend deployer::liquidity_pool;
    friend deployer::router;
    friend deployer::faucet;
    friend deployer::user_record;
    friend deployer::badges;
    ...
    fun init_module(caller:&signer) {
        ...
        // let signer_cap = resource_account::retrieve_resource_account_cap(swap_signer, @deployer);
         let (signer,signer_cap) = create_resource_account(caller,b"Diffusion");
    ...
    #[test_only]
    friend deployer::package_manager_tests;
}
